...
* =======================================================================
* 설명: 실제 회원가입과 로그인을 처리하는 페이지입니다.
* 사용자가 입력한 정보를 우리가 만든 api.js를 통해 서버로 전송합니다.
*/
  ...
  const handleSubmit = async (e) => {
    ...
    if (isLoginView) {
      ...
      try {
        ...
        // App.jsx로부터 받은 onLogin 함수를 호출하여 상태 업데이트
      ...
      try {
        ...
        setIsLoginView(true); // 회원가입 성공 후 로그인 폼으로 전환
      } catch (err) {
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
         ...
         <div className="text-sm text-center">
            <p className="text-gray-600">
              ...
              <button onClick={() => { setIsLoginView(!isLoginView); setError(''); setSuccess(''); }} className="font-medium text-brown-600 hover:text-brown-500 ml-1">
