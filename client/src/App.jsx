...
const PoshPetLogo = () => (
  <img 
    ...
    alt="PoshPet Logo" 
    // 로고 높이를 적절하게 조정하여 디자인 균형을 맞췄습니다.
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8">
              {services.map((service, index) => (
                <div key={index} className="p-6 md:p-8 rounded-xl shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300" style={{ backgroundColor: brandColors.bg }}>
                  ...
                  <h3 className="text-lg md:text-xl font-semibold mb-3" style={{ color: brandColors.textPrimary }}>{service.name}</h3>
                  <p className="text-sm md:text-base" style={{ color: brandColors.textSecondary }}>{service.description}</p>
                </div>
              ))}
            </div>
          </div>
